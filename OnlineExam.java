...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Which of these class is superclass of every class in Java?");
            jb[0].setText("String");jb[1].setText("Object");jb[2].setText("Abstract");jb[3].setText("ArrayList"); 
        }  
        if(current==1)  
        {  
